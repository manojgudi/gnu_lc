...
/*frompyobj*/
  ...
  /* Processing variable w */
  w_Dims[0]=m;
  capi_w_intent |= F2PY_INTENT_OUT|F2PY_OPTIONAL|F2PY_INTENT_IN;
  capi_w_tmp = array_from_pyobj(PyArray_DOUBLE,w_Dims,w_Rank,capi_w_intent,w_capi);
  if (capi_w_tmp == NULL) {
    if (!PyErr_Occurred())
...
/*frompyobj*/
  ...
  nrdata_Dims[0]=nest;
  capi_nrdata_intent |= F2PY_INTENT_OUT|F2PY_INTENT_CACHE|F2PY_INTENT_IN;
  ...
  fpint_Dims[0]=nest;
  capi_fpint_intent |= F2PY_INTENT_OUT|F2PY_INTENT_CACHE|F2PY_INTENT_IN;
  ...
  w_Dims[0]=m;
  capi_w_intent |= F2PY_INTENT_OUT|F2PY_INTENT_IN;
  capi_w_tmp = array_from_pyobj(PyArray_DOUBLE,w_Dims,w_Rank,capi_w_intent,w_capi);
  if (capi_w_tmp == NULL) {
    if (!PyErr_Occurred())
...
/*frompyobj*/
  ...
  ;
  capi_tx_intent |= F2PY_INTENT_OUT|F2PY_INTENT_IN;
  capi_tx_tmp = array_from_pyobj(PyArray_DOUBLE,tx_Dims,tx_Rank,capi_tx_intent,tx_capi);
  if (capi_tx_tmp == NULL) {
    if (!PyErr_Occurred())
  ...
  ;
  capi_ty_intent |= F2PY_INTENT_OUT|F2PY_INTENT_IN;
  capi_ty_tmp = array_from_pyobj(PyArray_DOUBLE,ty_Dims,ty_Rank,capi_ty_intent,ty_capi);
  if (capi_ty_tmp == NULL) {
    if (!PyErr_Occurred())
...
/*frompyobj*/
  ...
  ;
  capi_tp_intent |= F2PY_INTENT_OUT|F2PY_INTENT_IN;
